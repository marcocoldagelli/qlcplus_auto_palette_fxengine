#!/usr/bin/env python3
"""
qlcplus_auto_palette_fxengine.py  v1.2beta  Marco Coldagelli
==============================
...
def main():
    parser = argparse.ArgumentParser(
        description="QLC+ Auto Palette FX Engine v1.2beta by Marco Coldagelli",
    ...
    print(f"\n{'═'*64}")
    print(f"  QLC+ Auto Palette FX Engine v1.2beta by Marco Coldagelli")
